...
BOT_TOKEN = environ.get("BOT_TOKEN", "8119433870:AAEGIuZDnaEVjdOksULE-qGE5sAC2uj_nXM")

PICS = (environ.get('PICS', 'https://envs.sh/ISN.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6283322330').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "File_Sharing_Bot_4_bot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://Mastersender:17032008@cluster0.dt8i8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "Mastersender")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002448006795"))
